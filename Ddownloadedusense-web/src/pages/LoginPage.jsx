...
const ROLES = [
  ...
  { role: 'admin',   emoji: '🏛️', label: 'Admin',            desc: 'System management & reports',      color: '#10b981', user: 'admin',        pass: 'admin' },
  { role: 'parent',  emoji: '👨‍👩‍👧', label: 'Parent',           desc: 'Monitor child performance',        color: '#f59e0b', user: 'parent',       pass: 'parent' },
];
        ...
        {!selected ? (
          ...
          <div className="animate-in" style={{
            ...
            <button
              onClick={doLogin}
              style={{
                width: '100%', height: 40, background: selected.color, border: 'none',
            ...
            <div style={{
              ...
              Demo: {selected.user} / {selected.pass}
            </div>
